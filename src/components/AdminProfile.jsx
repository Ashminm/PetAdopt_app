    ...
    const handleProfileUpdate=async()=>{
        ...
        if(!username || !password || !email || !location || !phone || !Ad_image){
            ...
            if(preview){
                ...
                const result=await profileUpdateAdminApi(reqHeader,reqBody,JSON.parse(localStorage.getItem("currentUser"))._id)
...
// const uploadCatagory=(e)=>{
//     const {licenceId,catagories,allPets} =catagorydetails
        ...
        <div className="shadow h-100 mb-3">
            ...
            <div className="mt-4 row justify-content-center">
                <label htmlFor="profile" className="text-center">
                    <input type="file" id="profile" className="d-none" onChange={(e)=>setProfile({...profile,Ad_image:e.target.files[0]})} />
                    <img
                ...
                <div className="">
                    <ListGroup>
                        ...
                        <ListGroup.Item action variant="light" className="mb-3 ms-2 ">
                            <Link to={"/history"} className="text-decoration-none" style={{ color: "#94619E", fontWeight: "600" }}>
                            <i class="fa-solid fa-clock-rotate-left pe-2"></i>History
                            </Link>
                        </ListGroup.Item>
                        <div className="">
                            <p className="ps-2">Add Information</p>
                            <input type="text" className="form-control border-dark" defaultValue={profile.email}  onChange={(e)=>setProfile({...profile,email:e.target.value})}/>
                        </div>
                        ...
                        <Modal.Body>
                            ...
                            <i><p className="text-end pe-4 m-0" style={{fontSize:"12px"}}>Admin</p></i>
                        </Modal.Body>
                    </Modal>
                    </ListGroup>
                </div>
