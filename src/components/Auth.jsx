...
function Auth({ register }) {
  ...
  const toggleShowPassword = () => {
   ...
   const handleLogin=async(e)=>{
    ...
    return (
        <div className="d-flex justify-content-center align-items-center" style={{ backgroundImage: "linear-gradient(#F4DECB,#F8EEE7)", width: "100%", height: "85vh" }}>
  <div className="d-flex m-3 shadow" style={{ width: "100%", maxWidth: "650px", height: 'auto', backgroundColor: '#ffffff3d', flexWrap: 'wrap' }}>
    <div className="col-12 col-lg-5 p-5 d-flex flex-column align-items-center justify-content-center" style={{ backgroundColor: '#94619e2f' }}>
        ...
        {registration ? (
          <div>
            <Button
              ...
              style={{ backgroundColor: "#49274A", borderRadius: "30px" }} onClick={handleRegistration}
            >
              Sign up
            </Button>
          </div>
          ...
          <div>
            <Button
              type="submit"
              className="btn text-light ps-4 pt-2 pb-2 pe-4 w-100 mt-3"
              style={{ backgroundColor: "#49274A", borderRadius: "30px" }} onClick={handleLogin}
            >
              Login
            </Button>
            <hr />
            <p>Admin can also login</p>
            <p><Link to={'/'} className="text-dark">Back to Home</Link></p>
          </div>
        )}
      </Form>
    </div>
