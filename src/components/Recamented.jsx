                    ...
                    <Row className="p-2">
                        <Col sm="12" md="1 p-2" className=" d-flex justify-content-center align-items-center">
                            <div
                                ...
                                style={{ borderRadius: "50%", backgroundColor: "#49274A", padding: "15px 17px 13px 17px" }}
                            >
                        ...
                        <Col sm="12" md="9 p-2">
                            ...
                            <Card.Text className="text-dark">
                                Effortlessly discover and filter your favorite pets with a user-friendly search feature,
